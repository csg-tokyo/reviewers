...
=begin
  ...
  test "should create editor" do
    assert_difference('Editor.count') do
      post editors_url, params: { editor: { article_id: @editor.article_id, user_id: @editor.user_id } }
    end
  ...
  test "should update editor" do
    patch editor_url(@editor), params: { editor: { article_id: @editor.article_id, user_id: @editor.user_id } }
